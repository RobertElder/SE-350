...
void test_process_3() {
	...
	for(i = 0; i < testCases; i++){
		...
		result = 1
		*1+2-2+7%2-3*1%6+8/5-5/8*6+5+8/2*7+8-9-1%1+5%2%5%7%8%5%5-3+4
		+2/7-7-7-6+4*8+9-5%5%5*1%8*4%3-1/7-3+3/6*3-2/9%4-8-2*9%2+9%8
		*1/5-6-9-9*8/7*1+5+4-5/8*5*1%4-4%7+1*1%1/6%7-6-5/4+5*5-6+7*4
		...
		*0+7%6%9+6%8/6%4%5-9-6%5*7%9+6%2/7%8%6-0/8-4+9*8*7*5*2+8-7+3
		+7%6%5%3%5*3-3/6+3*3*3*3/8-3-7-6/6+6-8%7%1+2+6/6/7+6/6*8+4%6
		%4-8-6+7*3/9-3/2-5/1/7+7*0/4-9/8/4-3*7+7%9-1+5*9/3+0+4+0-7/2
		+7+5-1%2+2+9*2*4+1+0*7%4/7%5+8/5*8+8+8+1+3*5*3*1%8-6-0-8-0/6
		...
		%6-1+6-8+7*3*7+2-0/4-2+8-3+4-6%2%2*4-0%9/7-1*6*9%2*7+0/2+8-6
		*5/6+0*4/1%4*5*7*0*0/6%9-5/5-5%4/1*1%8/2%7/5-4+8%7*5+9+3%9-5
		/9*6-3/8*1+6%4*6+8-2/7+9%6/1*7-8*1%6*4-3+0%9%1/8%4-9*7-3-8-7
		*7*7*6/9-1-7-1*1%4*6+2/3*7+2/7-1*0%5-3*7-5/8%8+8+2%2*2-8+9%8
		...
		*0/3%2-4/5*2-9/9*6*8+4%1/9/8+0*2%4-5*6-4/2%1%3+5%1-7+3*4+8*1
		...
		//  Is math broken?
		if (!(result == 0x1B90 && order_checker(cur_index))) {
			break;
		}
	}
